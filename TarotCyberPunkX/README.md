...
# FOOD4THOTH CYBERPUNK-X TAROT (18+)

The Food4Thoth Cyberpunk-X Tarot is an immersive tarot reading experience featuring a futuristic, neon-infused tarot deck designed by DeJahn and Food4Thoth.

### Original Cards & Design by:

## **DeJahn and Food4Thoth**

---

# 🌌 Overview

This web-based application includes:
- Cyberpunk-inspired design elements
- Neon-lit visual effects powered by GLSL shaders
- Randomized tarot card selection
- Detailed interpretations for each card
- Text-to-speech integration for an interactive experience
- Multi-platform compatibility (desktop & mobile)

### 🔥 This version embraces a cyberpunk aesthetic, blending mysticism with digital chaos.

---

## Background Effect:

Colour Mix (GLSL Shader)
Shader Source: VaaLaa’s CodePen
...
- ✔️ **Interactive Tarot Reading** – Click to shuffle and reveal a card.
- ✔️ **Cyberpunk-Themed Custom Deck** – Dark neon visuals with an esoteric twist.
- ✔️ **GLSL Shader Background** – A shifting, glitch-inspired “Colour Mix” effect.
- ✔️ **Responsive Design** – Optimized for desktop, mobile, and tablets.
- ✔️ **Text-to-Speech Integration** – Listen to each card’s meaning read aloud.
- ✔️ **Age Verification Modal** (Standalone Version) – Required for 18+ content.
- ✔️ **iFrame-Compatible Popup Version** – For sites handling age verification externally.

---

# 🚀 Usage

### Standalone Version (With Age Verification)

For use as an independent tarot reading application with built-in age verification.

<iframe src="./indexAge.html" width="400" height="800"></iframe>

### Open indexAge.html in a browser.

Features in this version:
- Displays an age verification modal before accessing the tarot reading.
- Once confirmed, users can interact with the deck freely.

### iFrame Popup Version (Without Age Verification)

For embedding where age restrictions are handled externally.

Differences in this version:
- 🚫 No age verification modal (designed for sites already enforcing this).
- 🎴 Full tarot functionality in a popup-friendly format.

---

# 🎴 How to Use

Interacting with the Tarot Deck
1.  Click **“Randomize”** to shuffle and select a card.
2.	Click the selected card to stop shuffling.
3.	Click **“Description”** to reveal the card’s meaning.
4.	Click **“Play Audio”** to hear the full description read aloud.
5.	Press **“Space”** or Click again to draw a new card.

---

# Navigation & UI

- 🖥️ **Responsive Layout** – Works seamlessly across devices.
- 🛠️ **Neon Neumorphic UI** – Cyberpunk-inspired, glowing UI elements.
- 📂 **Expandable Menu System** – Connect to other Food4Thoth experiences.
...
- ⚡ GLSL Shaders (for animated “Colour Mix” background)
- ⚡ Web Speech API (text-to-speech for card readings)
- ⚡ WebGL & Canvas API (for real-time rendering)

---

# Shader Integration

This version features GLSL-powered Colour Mix, creating a trippy, neon distortion effect inspired by cyberpunk cityscapes.
...
- ✔️ **AI-Powered Tarot Readings** – Personalized AI-driven insights.
- ✔️ **Custom Deck Themes** – Swap designs for different moods.
- ✔️ **Live Tarot Reading Sessions** – Integration with real-time readings.
- ✔️ **Multi-Deck Selection** – Choose from historical, experimental, or sci-fi decks.

---

## 💌 Contact & Community

### 🌐 Website: Food4Thoth.com
### 🎨 Art Collective: Artabillies.com
### 📧 Email: food4thoth@proton.me

Follow us, dive into the neon dream, and let the Cyberpunk-X Tarot guide you. 🔮✨

---

## Why Explore Cyberpunk-X Tarot?

- 🔹 **Futuristic Esotericism** – A unique blend of mysticism & cyber-tech.
- 🔹 **Dynamic Visuals** – Neon-fused WebGL shaders create an immersive experience.
- 🔹 **AI & Divination** – Exploring next-gen tarot interpretation.
- 🔹 **Community-Centric** – Open-source, artist-driven, and evolving.

---

## 🤝 Support

## 🛠️ Your support helps fund:
- Esoteric Tech Projects
- Community Gardens & Art Initiatives
- Cyberpunk AI Research
...
Food4Thoth fuses ancient mysticism with cybernetic futurism:
- 🌀 **Creativity** – Art, imagination, and innovation fuel our projects.
- 🧩 **Exploration** – Bridging technology with esoteric wisdom.
- 🌍 **Community** – Connecting artists, thinkers, and seekers.
- 🎭 **Playfulness** – A mix of deep knowledge and interactive fun.

### 🔥 The Cyberpunk-X Tarot reimagines divination for a digital age.
...
🚀 Step into the cybernetic dreamscape – let the Cyberpunk-X Tarot reveal your fate. 🔮
