...
An interactive WebGL experience blending Conway’s Game of Life with touch-responsive controls.

---

# 🌍 Overview

Bergs of Life is an adaptation of a WebGL project originally created on CodePen, modified and enhanced by DeJahn & Food4Thoth to be:
- ✅ **Mobile-Responsive** – Scales seamlessly for all screen sizes.
- ✅ **Hybrid Compatibility** – Works both online & offline.
- ✅ **Touch-Responsive Controls** – Optimized for mobile gestures.
- ✅ **Game Mechanics Enhancements** – Expanded interactivity and gameplay.

---

## 🔗 Original CodePen Source: Bergs of Life - CodePen
...
# 🎮 How to Play
1.	Tap or press space to begin.
2.	Move the penguin using WASD keys or swipe gestures.
3.	Survive shifting icebergs that evolve like Conway’s Game of Life.
4.	Stay on stable ice – avoid the ocean!
5.	Watch the ocean levels – if they exceed 60%, the game ends.

---

# 📜 Features
- Penguin Movement: Supports keyboard & touch gestures.
- Game of Life Simulation: Icebergs dynamically change based on cellular automata rules.
- Realistic Animations: Icebergs melt, shift, and form over time.
- Mobile Optimization: Fully responsive for small and large screens.
...
# Simply visit:
🔗 Live Demo [BERGS OF THOTH](../bergs-of-life/index.html).

---

🎨 Credits & Contributors
- Original Concept & CodePen Prototype: FractalKitty
- Enhancements, Adaptations & Mobile Support: DeJahn & Food4Thoth

---

# 📚 Related Projects

Explore other interactive projects under Food4Thoth:
- Voice-Activated Visualizer
- Community Gardens Mapping
- Loop-Based Sound Stations
