...
# FOOD4THOTH Tarot Card Gallery

## Project Overview

Created by DeJahn & Food4Thoth, this project serves as the central landing page and showcase for 312 original tarot cards across four unique decks:
- Cyberpunk Dark
- Cyberpunk Melo
- Sacred Geometry
- OG Traditional

It also integrates four interactive tarot apps, each dedicated to a specific deck, and organizes all tarot-related webpages and applications for seamless navigation.

---

# Features & Functionality

1. **Tarot Card Display & Sorting**      
	•	Users can explore and sort through all 312 tarot cards from the four decks.      
	•	Each deck is accessible via an interactive web interface.      

2. **Tarot Apps**      
	•	Each deck has its own dedicated web app that allows users to interact with the tarot cards in an immersive experience.      
	•	A random card pull feature lets users draw a card from the collection.      

3. **Centralized Navigation System**      
	•	A neumorphic navigation menu allows users to explore various sections, including:      
	•	Black Business Eugene Directory      
	•	Community Gardens      
	...
	•	Tide Walk      
	•	Trent Storybook      
	•	Hashisheen Album Reviews and more.      

4. **Embedded Interactive Previews**      
	•	Each tarot deck is previewed with an embedded iframe that displays a live view of the corresponding web app.      

5. **Image Gallery**      
	•	A categorized tarot card gallery for users to browse through Major Arcana, Wands, Cups, Swords, and Pentacles.      
	•	Users can sort by deck or category.      

6. **Random Tarot Card Draw**      
	•	A “PULL CARD” button allows users to randomly draw a tarot card, revealing its name, image, description, and a link to the relevant app.      

7. **Smooth User Experience**      
	•	Optimized iframes that resize dynamically.      
	•	Scroll-to-top and scroll-to-bottom buttons for easy navigation.
...
- Neumorphic UI elements for a modern and immersive aesthetic
- Preloaded iframe sources for optimized page load speed
- Dynamic JavaScript-based card selection system

---

# Navigation & User Interaction
- Custom JavaScript navigation script (nav_script2.js) handles dynamic menu expansion.
- JavaScript-powered random tarot card selection.
- Smooth scrolling and popup modal functionality.
...
# Future Enhancements
- Expanded Tarot Deck Collection: Adding more decks, including Crystal Queens Tarot and CyberPunk X Tarot.
- Personalized Readings & Spread Generator: Users can create custom tarot spreads.
- Enhanced Mobile Experience: Optimizing UI for mobile tarot app integration.
-Dark Mode UI Option
...
# Contributors
- DeJahn (Co-Founder, Developer, Designer)
- Food4Thoth (Creative Concept, Tarot Artwork, UI/UX)
...
© 2025 Food4Thoth. All rights reserved. Unauthorized redistribution, copying, or modification without explicit permission is prohibited.
	...
	“Art and technology merge to reveal the unseen.”
