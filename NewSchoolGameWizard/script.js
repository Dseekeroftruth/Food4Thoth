...
let scaleFactor1 = inIframe ? 0.3 : 1;
        ...
        playerImg.src = './images/player3.PNG';

        const enemyImg = new Image();
        enemyImg.src = './images/enemy6.PNG';

        const gemImg = new Image();
        gemImg.src = './images/gem3.PNG';

        const powerupSpeedImg = new Image();
        powerupSpeedImg.src = './images/powerup_speed5.PNG';

        const powerupInvincibleImg = new Image();
        powerupInvincibleImg.src = './images/powerup_invincible3.PNG';

        const powerupMultiplierImg = new Image();
        powerupMultiplierImg.src = './images/powerup_multiplier4.PNG';

        const backgroundImg = new Image();
        backgroundImg.src = './images/2background.PNG';
    ...
    // Reposition objects proportionally
    ...
    // Generate a random position that ensures the object stays fully within the canvas
...
function createRandomEnemy() {
  ...
  let enemy = {
    ...
    while (isColliding(enemy, player)) {
        enemy.x = getRandomPosition(canvas.width, 150);
        enemy.y = getRandomPosition(canvas.height, 150);
    }
...
function updatePlayerMovement() {
    ...
    const hitboxReductionA = 0.3; // 20% smaller hitbox for 'a'
    const hitboxReductionB = 0.3; // 20% smaller hitbox for 'b'
