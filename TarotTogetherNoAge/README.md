...
<h1 style="text-align: center;">FOOD4THOTH Tarot Card Gallery README</h1>

## Project Overview
Created by **DeJahn & Food4Thoth**, this project is your **central landing page and showcase** for **234 original tarot cards** across **three** unique decks:

1. **Sacred Geometry** (78 Cards)  
2. **CyberPunk Melo** (78 Cards)  
3. **CyberPunk Dark** (78 Cards)

Each deck can be explored via its **dedicated app** or through a **combined gallery**. This README also lists all tarot-related webpages for easy navigation.
...
1. **Tarot Card Display & Sorting**  
   - Explore and **flip through** the 234 tarot cards from the 3 featured decks.  
   - Each deck is accessible via its own **interactive** interface.

2. **Tarot Apps**  
   - Dedicated **web apps** for each deck, providing immersive experiences.  
   - **Random card pull** feature that reveals card art, name, and short descriptions.

3. **Centralized Navigation**  
   - A **neumorphic menu** leads to various sections, including:  
     - Games  
     - I Ching  
     - Community Gardens  
     - Black Business Eugene  
     - Anarchy & Akashic Info  
     - And more…

4. **Embedded Interactive Previews**  
   - Each tarot deck can be **previewed** via embedded iframes or opened in full-screen.

5. **Categorized Image Gallery**  
   - Browse the full set in categories: Major Arcana, Wands, Cups, Swords, and Pentacles.  
   - Quickly filter by deck or category.

6. **Random Tarot Card Draw**  
   - A "PULL CARD" button to **randomly draw** from all available decks or a specific one.  
   - Display includes name, image, brief interpretation, and direct app link.

7. **Optimized & User-Friendly**  
   - All iframes dynamically sized for different screen resolutions.  
   - **Scroll-to-top** and **scroll-to-bottom** buttons for smooth navigation.
...
- **Neumorphic UI elements** for a modern look  
- **Dynamic** JS-based card selection  
- Preloading **tarot card images** for speed

### Navigation & Interaction
- **Custom JS** for dynamic menu expansion (nav_script.js / nav_script2.js)  
- Smooth scrolling & modals for card details  
- Random card draws with short or extended readings
...
#Future Enhancements
1. **Additional Decks**: Possibly add the OG Traditional or 18+ decks.
2. **Spread Generator**: Tools for Celtic Cross, Past-Present-Future, etc.
3. **Mobile Optimization**: Further refining layout on phones & tablets.
4. **AI Interpretations**: ChatGPT-style readings.
5. **Dark Mode**: Optional theme toggling.

### Contributors
- **DeJahn**: Developer, Designer
