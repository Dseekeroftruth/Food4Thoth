...
# De’Jahn & Food4Thoth Tarot OG Traditional Card

## Project Overview

Food4Thoth Tarot OG Traditional Card is an interactive, multimedia Tarot experience developed by De’Jahn, blending traditional Tarot archetypes with innovative digital design and immersive elements. This project integrates WebGL-based Neuro Noise Shader, voice recognition, audio playback, and an intuitive UI to create an interactive Tarot reading environment.

---

# About De’Jahn

De’Jahn is a multidisciplinary creator and co-founder of Artabillies, an artistic collective that merges contemporary and traditional art forms. His work explores the fusion of esoteric symbolism, technology, and interactive media, bringing experimental projects like Food4Thoth to life.

This Tarot application is part of De’Jahn’s ongoing exploration of “alien language” in coding, where he designs interfaces that engage both the intuitive and analytical mind.

---

# Features

1. **Dynamic Tarot Card Interaction**      
	•	Randomized Tarot Draws: Users can pull a card at random.      
	•	Animated Card Display: Each drawn card features a high-resolution image.      
	•	Short and Full Descriptions: Users can access a brief summary or a detailed esoteric interpretation of each card.      

2. **WebGL Shader Integration**
	•	Neuro Noise Shader (based on GLSL) provides a shifting, dreamlike background that enhances the mystical aesthetic.      
	•	Originally inspired by the CodePen demo by Ksenia K.      

3. **Audio Narration & Voice Commands**      
	•	Text-to-Speech for Tarot Descriptions: Users can listen to card meanings in an AI-generated voice.      
	•	Speech Recognition: Users can control the application with voice commands, including:      
	•	“Pull a card” → Draws a new Tarot card.
	•	“Show description” → Displays the short description.      
	•	“Read full description” → Plays the full card explanation via speech synthesis.      
	•	“Stop reading” → Stops audio playback.      
	•	“Play music” / “Stop music” → Controls background sound.      

4. **Ambient Sound & Music Integration**      
	•	Background music enhances the Tarot reading experience.      
	•	Custom soundscapes will be incorporated in future updates.

5. **Intuitive UI with Interactive Navigation**      
	•	Neumorphic UI design gives buttons and tabs a soft, glowing effect.      
	•	Expandable Menu System allows navigation between different sections of Food4Thoth (Black Business Directory, Community Gardens, Sound Visualizers, Games, I Ching, etc.).
...
UI Design	HTML, CSS (Neumorphism)
JavaScript Logic	Vanilla JS
File Handling	Fetch API (for loading descriptions)
...
1. Prerequisites
	•	A modern web browser (Chrome recommended) that supports WebGL and Web Speech API.      
	•	Microphone access enabled (for voice commands).      

2.	Open the index.html file in a browser.      

3. Using the Features
	•	Click “Pull Tarot” or say “Pull a card” to draw a random Tarot card.      
	•	Click “Show Description” to see a brief meaning or “Read Full Description” to hear an in-depth analysis.      
	•	Toggle music playback for ambiance.      
...
# Future Enhancements
- Expanded Voice Commands: Adding advanced NLP processing for a more conversational AI experience.
- User Customization: Allow users to upload their own Tarot decks and personalize the interface.
-Deeper Esoteric Insights: Integration of Astrology, I Ching, and other divinatory systems.
	
---

# Credits & Acknowledgments
- Developed & Designed by: De’Jahn
- Shader Inspiration: Neuro Noise Shader by Ksenia K
- Music & Sound Design: [De'Jahn]
- Part of: Food4Thoth & Artabillies Creative Projects
