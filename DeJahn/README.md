---
layout: default
title: "DeJahn’s Music Collection README"
description: "A psychedelic, glitch-powered sound journey into DeJahn’s immersive art and experimental audio archive."
permalink: /DeJahn/readme/
image: /images/og-preview.jpg

# SEO Tags (used by jekyll-seo-tag plugin)
og_title: "DeJahn’s Music Collection"
og_description: "Sonic exploration meets glitch visuals in this psychedelic journey through sound and story."
og_image: /images/og-preview.jpg

twitter_card: summary_large_image
twitter_title: "DeJahn’s Music Collection"
twitter_description: "Immersive audio gallery by DeJahn | Part of the FOOD4THOTH creative network"
twitter_image: /images/og-preview.jpg
---

# DeJahn’s Music Collection  
...
# Features
- Glitch-Effect Hero & Animations
A captivating intro with animated glitch text and ambient background color-shift illusions.
- Sticky Neumorphic Navigation
Access dozens of portals, tools, collectives, and games via an expandable, mobile-friendly nav.
- Slideshow Art Gallery
Scrollable image showcase featuring photos and performance stills.
- Video Archive
Embedded videos from YouTube and Facebook, grouped by theme (Improv, Drum Kits, HAPI Pan, Experimental Lunch Breaks, and more).
- Parallax Sections
Rich immersive sections with layered backgrounds for philosophical statements and creative expression.
- Music Integration with Community

---
	
## Connects to broader collections like:
- Seeker and the Star
- Ground Cherry
- INPROGRESSION
- Peruvian Melt
...
# How to Use
- Scroll through the immersive homepage.
- Click videos to explore various musical styles.
- Navigate between projects using the floating neumorphic menu.
- Tap any of the glitch titles or parallax banners for inspiration.

---

# Technology Stack
- HTML5 / CSS3 / JavaScript
- Facebook & YouTube embeds
- Neumorphism UI Design
- Glitch Effects (Custom CSS Animations)
- Responsive Layouts & Sticky Elements
- Parallax Scrolling Illusions
...
→ Make a Donation
Support psychedelic art, musical freedom, and digital liberation.
