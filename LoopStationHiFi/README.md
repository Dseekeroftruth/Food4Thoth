---
layout: default
title: "Loop HIFI Mixer README"
description: "Cyberpunk Music Mixer with advanced Tone.js audio effects—featuring neon UI, real-time reverb, distortion, phaser, and modular track selection. Powered by FOOD4THOTH."
permalink: /LoopStationHiFi/readme/
image: https://www.food4thoth.com/LoopStationHiFi/LoopHifi.png

og_title: "Loop HIFI Mixer | Food4Thoth"
og_description: "Explore the futuristic Cyberpunk Music Mixer—an immersive audio playground with real-time effects and modular loops, part of the FOOD4THOTH interactive experience."
og_image: https://www.food4thoth.com/LoopStationHiFi/LoopHifi.png

twitter_card: summary_large_image
twitter_title: "Loop HIFI Mixer | Food4Thoth"
twitter_description: "Real-time audio manipulation meets neon visuals—Cyberpunk Loop Mixer with advanced effects like BitCrusher, AutoFilter, and more. Dive into sound."
twitter_image: https://www.food4thoth.com/LoopStationHiFi/LoopHifi.png
---
...
# 🎛 Cyberpunk Music Mixer + Advanced Effects

## 🎶 Overview  
**Cyberpunk Music Mixer + Advanced Effects** is a futuristic music mixing application powered by **Tone.js**. With a cyberpunk aesthetic—featuring neon colors, the Orbitron font, and dark, radial-gradient backgrounds—the app lets users select songs, toggle individual track playback, and adjust advanced audio effects like Distortion, Chorus, Phaser, AutoWah, Vibrato, AutoFilter, BitCrusher, Reverb, and Delay.
...
- **Song & Track Management**:  
  ...
  - Dynamic display of tracks with toggle checkboxes.  
  - Play all, stop all, or play selected tracks.

- **Advanced Effects Controls**:  
  - **Distortion**: Adjust amount and wet value.  
  - **Chorus**: Set frequency, depth, and wet value.  
  - **Phaser**: Control frequency, octaves, and wet value.  
  - **AutoWah**: Modify base frequency, octaves, and wet value.  
  - **Vibrato**: Adjust frequency, depth, and wet value.  
  - **AutoFilter**: Set frequency, depth, and wet value.  
  - **BitCrusher**: Change bit depth and wet value.  
  - **Reverb**: Adjust decay and wet value.  
  - **Delay**: Control delay time, feedback, and wet value.

- **Cyberpunk UI & Navigation**:  
  - A neon-themed interface with cyberpunk fonts and glow effects.  
  - A responsive, multi-column track layout.  
  - A neumorphic navigation sidebar for quick access to Food4Thoth pages.

---

## 🛠 Technologies Used  
- **HTML5, CSS3, JavaScript**  
- **[Tone.js](https://tonejs.github.io/)** for real-time audio processing  
- **Google Fonts (Orbitron)** for cyberpunk typography  
- Custom CSS for neon and cyberpunk styling
